...
int main(int argc, char** argv)
{
    ...
    std::ofstream lanes_file("../output/lanes.obj");
    lanes_file << road_network_mesh.get_lanes_mesh().get_obj() << std::endl;
    lanes_file.close();

    std::ofstream objects_file("../output/objects.obj");
    objects_file << road_network_mesh.get_roadobjects_mesh().get_obj() << std::endl;
    objects_file.close();

    std::ofstream roadmarkings_file("../output/roadmarkings.obj");
    roadmarkings_file << road_network_mesh.get_roadmarks_mesh().get_obj() << std::endl;
    roadmarkings_file.close();
